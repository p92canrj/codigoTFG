...
* `<nombre_modelo>`: Nombre del estimador/clasificador a utilizar (a elegir entre: `logisticat`, `logisticregressor`, `lightgbmclassifier_fast`, `nnop`, `ordinaldecomposition`, `nnpom`).
